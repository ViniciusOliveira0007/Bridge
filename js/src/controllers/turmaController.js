...
exports.addAlunoTurma = addAlunoTurma;
exports.removeAlunoTurma = removeAlunoTurma;
exports.getCursos = getCursos;
exports.getTurmasDoAluno = getTurmasDoAluno;
exports.getTurmasDoProfessor = getTurmasDoProfessor;
...
function getTurmas(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const turmas = yield prisma.turma.findMany({
                include: {
                    curso: {
                        select: {
                            id: true,
...
function createTurma(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // CRIAR A TURMA
            // ========================================
            const novaTurma = yield prisma.turma.create({
                data: {
                    nome: nome.trim(),
...
function updateTurma(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const turmaExistente = yield prisma.turma.findUnique({
            ...
            // Atualizar a turma
            const turmaAtualizada = yield prisma.turma.update({
                where: { id: parseInt(turmaId) },
                data: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (nome && { nome: nome.trim() })), (sigla && { sigla: sigla.toUpperCase().trim() })), (descricao !== undefined && { descricao: descricao ? descricao.trim() : null })), (cor && { cor })), (corTexto && { corTexto })),
                include: {
                    curso: true,
                    professor: {
                        select: {
...
// ========================================
function getMembros(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { turmaId } = req.params;
            console.log("👥 Buscando membros da turma:", turmaId);
            const membros = yield prisma.turmaAluno.findMany({
                where: {
...
// ========================================
function addAlunoTurma(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { turmaId } = req.params;
            ...
            const jaInscrito = yield prisma.turmaAluno.findUnique({
                where: {
                    turmaId_alunoId: {
                        turmaId: parseInt(turmaId),
            ...
            // Adicionar aluno à turma
            const inscricao = yield prisma.turmaAluno.create({
                data: {
                    turmaId: parseInt(turmaId),
                    alunoId: parseInt(alunoId)
                },
...
function removeAlunoTurma(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Remover aluno da turma
            yield prisma.turmaAluno.delete({
                where: {
                    turmaId_alunoId: {
                        turmaId: parseInt(turmaId),
                        alunoId: parseInt(alunoId)
...
// ========================================
function getTurmasDoAluno(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { alunoId } = req.params;
            console.log("📚 Buscando turmas do aluno:", alunoId);
            const turmasDoAluno = yield prisma.turmaAluno.findMany({
                where: {
                    alunoId: parseInt(alunoId)
                },
                include: {
...
// ========================================
function getTurmasDoProfessor(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { professorId } = req.params;
            console.log("📚 Buscando turmas do professor:", professorId);
            const turmasDoProfessor = yield prisma.turma.findMany({
                where: {
                    professorId: parseInt(professorId)
                },
                include: {
